...
public class CategoriaController {
	...
	public ResponseEntity<List<ModelCategoria>> getByDescricaoCategoria(@PathVariable String descricaoCategoria){
	...
	public void delete(@PathVariable Long id) {
		java.util.Optional<ModelCategoria> modelCategoria = categoriaRepository.findById(id);
		
		if(modelCategoria.isEmpty())
